...
import { useSelectedNetwork } from "~~/hooks/core";
import { useDeployedContractInfo } from "~~/hooks/core";
import { AllowedChainIds } from "~~/utils/core";
import { replacer } from "~~/utils/core/common";
import {
  ContractAbi,
  ContractName,
  UseScaffoldEventHistoryConfig,
  UseScaffoldEventHistoryData,
} from "~~/utils/core/contract";
 ...
 * @param config.watch - if set to true, the events will be updated every pollingInterval milliseconds set in config/networks.ts (default: false)
