...
import { Contract, ContractName } from "~~/utils/core/contract";

/**
 * Gets a viem instance of the contract present in deployedContracts.ts or externalContracts.ts corresponding to
 * targetNetworks configured in config/networks.ts. Optional walletClient can be passed for doing write transactions.
