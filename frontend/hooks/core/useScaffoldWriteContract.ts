...
import { useDeployedContractInfo, useTransactor } from "~~/hooks/core";
import { AllowedChainIds, notification } from "~~/utils/core";
import {
  ContractAbi,
  ContractName,
 ...
 * the contracts present in deployedContracts.ts & externalContracts.ts corresponding to targetNetworks configured in config/networks.ts
