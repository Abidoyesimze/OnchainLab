...
export type AllowedChainIds = (typeof targetNetworks)[number]["id"];
...
/**
 * @returns targetNetworks array containing networks configured in config/networks including extra network metadata
 */
